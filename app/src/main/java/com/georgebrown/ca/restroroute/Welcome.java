...
public class Welcome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(Welcome.this, R.array.resturant_tags, android.support.v7.appcompat.R.layout.support_simple_spinner_dropdown_item);
