...
import com.georgebrown.ca.restroroute.database.AppDatabase;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(view.getContext(), com.georgebrown.ca.restroroute.ResturantDetailsScreen.class);
        ...
        btnSearchTag.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.apply();
                Intent intent = new Intent(ResturantList.this, com.georgebrown.ca.restroroute.TagResturantList.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.itemAboutUs:
                startActivity(new Intent(this, com.georgebrown.ca.restroroute.AboutUs.class));
                finish();
                return true;
